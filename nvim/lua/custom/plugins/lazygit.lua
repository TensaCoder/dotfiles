return {
	...
	config = function()
		...
		-- Terminal mode mappings for scrolling inside LazyGit floating window
		vim.keymap.set('t', '<S-Up>', '<C-U>', { noremap = true, silent = true }) -- Scroll up by half a page
		vim.keymap.set('t', '<S-Down>', '<C-D>', { noremap = true, silent = true }) -- Scroll down by half a page
	end,
}
