...
-- To import the options and keymaps from /lua/custom/ directory
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        git_files = {
          previewer = false,
          show_untracked = true, -- **Added this to ensure untracked files are visible**
        },
      }
  ...
  },
  {
    ...
    config = function()
      require("custom.plugins.navic-config") -- This will load the config
    end
  },
  {
